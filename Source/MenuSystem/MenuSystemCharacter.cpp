...
AMenuSystemCharacter::AMenuSystemCharacter() :
	// Create delegate and bind callback function
...
{
	/* Callback for the delegate 'CreateSessionCompleteDelegate' */
	if (bWasSuccessful)
	{
		if (GEngine)
		{
		...
		// Travel to lobby if session was created
